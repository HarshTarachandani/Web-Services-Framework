...
public class ServiceDoc
{
 public static void main(String gg[])
 {
  ...
  //String executionPath="c:\\tomcat9\\webapps\\TMWEBRocks\\WEB-INF\\classes";
  ...
  { 
   ...
   if(errorList.size()>0)
   {
    ...
    while(i<errorList.size())
    {
     ...
     preface.add(new Paragraph("Annotation : "+s1.path));
     preface.add(new Paragraph(" "));
     preface.add(new Paragraph("Class : "+s1.serviceClass.getCanonicalName()));
     preface.add(new Paragraph(" "));
     preface.add(new Paragraph("Method : "+s1.service.getName()));
     preface.add(new Paragraph(" "));
     preface.add(new Paragraph(" "));
     i++;
    }
   ...
   else
   {
    ...
    {
     preface.add(new Paragraph("Path : "+s1.path));
     preface.add(new Paragraph(" "));
     preface.add(new Paragraph("Class : "+s1.serviceClass.getCanonicalName()));
     preface.add(new Paragraph(" "));
     preface.add(new Paragraph("Method : "+s1.service.getName()));
     preface.add(new Paragraph(" "));
     preface.add(new Paragraph("Parameters : "+s1.service.getParameters().length));
     preface.add(new Paragraph(" "));
     preface.add(new Paragraph("Return Type : "+s1.service.getReturnType()));
     preface.add(new Paragraph(" "));
